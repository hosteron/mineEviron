...
UNAME_R := 3.4.36+
KERNEL_SOURCE_DIR = $(PLATFORM_DIR)/../linux-tek210/install/root/usr/src/$(UNAME_R)
KERNEL_USER_INC_DIR = $(PLATFORM_DIR)/../linux-tek210/install/root/usr/include
KMOD_INSTALL_DIR = $(PLATFORM_DIR)/../linux-tek210/install/root/usr/lib/modules/$(UNAME_R)

BOOTLOADER_DEP_PROJS = tiny210-u-boot

RECOVERY_DEP_PROJS = gcc-linaro-arm-linux-gnueabihf embfs tiny210_boot_scripts linux-tek210 udev busybox kmod
...
DEP_PROJS += embfs
DEP_PROJS += tiny210_boot_scripts
DEP_PROJS += linux-tek210
DEP_PROJS += zlib
